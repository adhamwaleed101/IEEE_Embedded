...
Std_ReturnType MCAL_RCC_SetPLL(u8 input_clock,u8 multiplier)
{
    Std_ReturnType Local_FunctionStatus = E_NOT_OK;
    if (multiplier > 10){
    ...
    if (RCC_SYSCLK * multiplier > 72000000){
        #error "invalid multiplier, exceed 72mHz"
        return Local_FunctionStatus
    ...
    switch(multiplier)
    {
        ...
        case 4:
            ...
            CLR_BIT(RCC_CFGR, RCC_CFGR_PLLMUL_4);
            Local_FunctionStatus = E_OK;
            break;
         ...
         case 5:
            ...
            CLR_BIT(RCC_CFGR, RCC_CFGR_PLLMUL_2);
            SET_BIT(RCC_CFGR, RCC_CFGR_PLLMUL_3);
            SET_BIT(RCC_CFGR, RCC_CFGR_PLLMUL_4);
            Local_FunctionStatus = E_OK;
            break;
         case 6:
            CLR_BIT(RCC_CFGR, RCC_CFGR_PLLMUL_1);
        ...
        case 9:
            ...
            Local_FunctionStatus = E_OK;
            break;
        case 10: /*Multiplies by 6.5 written as 10 to keep integer form*/
